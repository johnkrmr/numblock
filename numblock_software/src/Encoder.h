...
public:
  Encoder(int8_t A, int8_t B, int8_t BTN = -1, 
               uint8_t stepsPerNotch = 4, bool active = LOW);
			   
#ifndef WITHOUT_BUTTON
  explicit Encoder(int8_t BTN, bool active = false);   // Depricated.  Use Digtial Button instead

#endif

  voidFuncPtr service(void);  
